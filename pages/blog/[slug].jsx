...
//     //test in browser https://react.webworker.berlin/graphql?query={posts%20{nodes%20{slug}}}
...
//     const responseObjekt = await response.json();

//     post = responseObjekt.data.post;
